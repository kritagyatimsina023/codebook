...
const OrderSuccess = ({ data }) => {
  const [randomId] = useState(() => {
    const numberStr = String(Math.random());
    const id = numberStr.split(".").join("").slice(1, 6);
    console.log(id);
    return id;
  });
