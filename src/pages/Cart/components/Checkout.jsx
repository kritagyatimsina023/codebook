...
export const Checkout = ({ setCheckout }) => {
  ...
  async function handleOrderSubmit(e) {
    ...
    try {
      ...
      clearCart();
      navigate("/order-summary", { state: { data: data, status: true } }); // this goes to the order page (this is an state )
    } catch (error) {
      navigate("/order-summary", { state: { message: error, status: false } }); // this goes to the order page (this is an state )
    }
  }
  useEffect(() => {
